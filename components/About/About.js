  ...
  return (
    <div>
      ...
      <div class="mx-auto flex justify-center items-center bg-white p-5 sm:flex">
        <img
          class="h-36"
          src="https://i.ibb.co/QHjcc5v/Screenshot-2023-03-31-100804-removebg-preview.png"
          alt=""
        />
        ...
        <div class="justify-between p-5 space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
          <div class=" sm:w-auto bg-white  focus:ring-4 focus:outline-none focus:ring-gray-300 text-white rounded-lg inline-flex items-center justify-center px-4 py-2.5 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
            <div class="text-left">
              <img
                ...
                class=""
                src="https://i.ibb.co/hcrYTBs/Untitled-3.png"
                alt=""
              />
            </div>
          </div>
          ...
          <div class=" sm:w-auto bg-white  focus:ring-4 focus:outline-none focus:ring-gray-300 text-white rounded-lg inline-flex items-center justify-center p-5 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
            <div class="text-left">
              ...
              <h1 class="text-4xl font-semibold text-gray-600 dark:text-white">
                BERTUMBUH - Save The<br></br> World{" "}
              </h1>
              <br></br>
          ...
          <div class="sm:w-auto bg-white  focus:ring-4 focus:outline-none focus:ring-gray-300 text-white rounded-lg inline-flex items-center justify-center p-5 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
            <div className="text-left">
              ...
              <h1 class="text-4xl font-semibold text-gray-600 dark:text-white mr-5">
                Kenapa BERTUMBUH <br></br> Butuh Kamu ?{" "}
              </h1>
              <br></br>
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                BERTUMBUH - Adalah organisasi non-profit yang mempunyai{" "}
